...
Blood::Blood(b2World* world,CCPoint pos,int ID,int rotation):PhysicsObject(world,pos,ID,rotation)
{
    //this->addBody();
    ...
    schedule( schedule_selector(Blood::tick) );
}
...
void Blood::setObjectTexture()
{
    
    this->texture = CCTextureCache::sharedTextureCache()->addImage("blood.png");
